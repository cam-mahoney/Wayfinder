...
export const cards = [
  { title: "Subheading 1", body: "Body text for whatever you’d like to add more to the subheading." },
  { title: "Subheading 2", body: "Body text for whatever you’d like to expand on the main point." },
  { title: "Subheading 3", body: "Body text for whatever you’d like to share more." },
];
